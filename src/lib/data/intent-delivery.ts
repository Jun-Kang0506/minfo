...
export const INTENT_DELIVERY_METADATA: Record<string, IntentDeliveryMetadata> = {
  ...
  my_number_update: { intentId: "my_number_update", deliveryKind: "static_guidance", claimLevel: "information", sourceIds: ["shinjuku-my-number", "my-number-card-portal"], datasetCandidateIds: [], verifiedAt: "2026-08-22", freshnessPolicy: "curated official guidance", researchStatus: "verified_content" },
  my_number_find: { intentId: "my_number_find", deliveryKind: "static_guidance", claimLevel: "information", sourceIds: ["shinjuku-my-number", "my-number-card-portal"], datasetCandidateIds: [], verifiedAt: "2026-08-22", freshnessPolicy: "curated official guidance", researchStatus: "verified_content" },
  student_part_time_work: { intentId: "student_part_time_work", deliveryKind: "static_guidance", claimLevel: "information", sourceIds: ["isa-student-work"], datasetCandidateIds: [], verifiedAt: "2026-08-22", freshnessPolicy: "curated official immigration guidance", researchStatus: "verified_content" },
