...
export const ANSWER_TEMPLATES: AnswerTemplate[] = [
  {
    ...
    content: {
      ...
      ja: {
        direct:
          "日本語がわからなくても、病院に行くことができます。国の公式サイト「医療情報ネット（ナビイ）」で、ことばが通じる病院をさがすことができます。",
        steps: [
          "「医療情報ネット（ナビイ）」で、近くの病院をさがしてください。",
          "在留カードと保険証を持っていってください。",
          "こまったときは、しんじゅく多文化共生プラザで相談できます。",
        ],
        safety: "いまとても具合がわるいときは、119に電話して救急車をよんでください。",
      },
      zh: {
        direct:
  ...
  },
  {
    ...
    content: {
      ...
      ja: {
        direct:
          "日本に 3か月より長く住む人は、健康保険に入ります。「国民健康保険」のカードがあると、病院のお金はふつう 30%だけになります。",
        steps: [
          "新宿区役所で国民健康保険に入ってください（会社で入る人もいます）。",
          "お金（保険料）は収入できまります。はらう紙が家にとどきます。",
          "病院や薬局では、いつも保険証を見せてください。",
        ],
        safety: "くわしいルールは人によってちがいます。新宿区役所でかくにんしてください。",
      },
      zh: {
        direct:
  ...
  },
  {
    ...
    content: {
      ...
      ja: {
        direct:
          "新宿区では、ごみを分けて出します。もえるごみ、金属・ガラス、プラスチック、びん・かん、紙、大きいごみなどです。出す曜日は住所でちがいます。",
        steps: [
          "自分の住所のごみの曜日を、新宿区のサイトか建物のけいじばんで見てください。",
          "ごみの日の朝 8時までに、透明のふくろで出してください。",
          "大きいごみは、先に電話やネットで予約が必要です（お金がかかります）。",
        ],
      },
      zh: {
        direct:
  ...
  },
  {
    ...
    content: {
      ...
      ja: {
        direct:
          "地震のときは、あたまをまもって、つよいテーブルの下に入ってください。まどからはなれてください。ゆれているあいだは、外に出ないでください。",
        steps: [
          "自分の家の近くのひなん場所を、前もってしらべてください（新宿区の地図があります）。",
          "水と食べものを 3日分よういしてください。",
          "「東京都防災」のサイトで、いろいろなことばの情報が見られます。",
        ],
        safety: "けがをした人や火事があるときは、すぐ 119に電話してください。",
      },
      zh: {
        direct:
  ...
  },
  {
    ...
    content: {
      ...
      ja: {
        direct:
          "どこの窓口かわからなくても、だいじょうぶです。しんじゅく多文化共生プラザで、いろいろなことばで無料相談ができます。四ツ谷の FRESCにも、国の相談窓口があつまっています。",
        steps: [
          "まずしんじゅく多文化共生プラザに行ってください。正しい窓口をおしえてくれます。",
          "在留資格や仕事のことは、FRESCで相談できます（通訳があります）。",
          "新宿区役所には、外国人のための相談窓口があります。",
        ],
      },
      zh: {
        direct:
  ...
  },
  {
    ...
    content: {
      ...
      ja: {
        direct:
          "税金の手紙は、お金をはらうか、手続きが必要という意味が多いです。よくあるのは住民税（新宿区から）と年金（日本年金機構から）です。手紙をそのままにしないでください。",
        steps: [
          "手紙の送り主（どこから来たか）を見てください。",
          "その事務所か、相談窓口に手紙を持っていってください。いっしょに読んでくれます。",
          "はらうのがむずかしいときは、へらす・わける制度があります。聞いてみてください。",
        ],
        safety: "あなたの税金の金額は、MINFOではわかりません。手紙を出した事務所でかくにんしてください。",
      },
      zh: {
        direct:
  ...
  },
  {
    ...
    content: {
      ...
      ja: {
        direct:
          "日本で家をかりるとき、特別なルールがあります。保証人か保証会社が必要なことが多いです。はじめに敷金・礼金というお金もかかります。",
        steps: [
          "契約の前に、東京都の外国人向けガイドブックを読んでください。",
          "わからないことがあったら、相談窓口で契約書をいっしょに見てもらってください。",
          "はじめのお金は、家賃の 4〜6か月分くらいかかることが多いです。",
        ],
        safety: "大家さんや不動産屋さんとトラブルになったら、FRESCや専門家に相談してください。",
      },
      zh: {
        direct:
  ...
  },
  {
    ...
    content: {
      ...
      ja: {
        direct:
          "在留カードをなくしても、あわてないでください。決まった手続きがあります。まず警察にとどけて、14日以内に入管（にゅうかん）で新しいカードをもらいます。",
        steps: [
          "交番か警察署で「なくしました」ととどけてください（番号をもらえます）。",
          "14日以内に、東京出入国在留管理局で再発行の手続きをしてください。写真とパスポートが必要です。",
          "わからないときは、FRESCで通訳つきで相談できます。",
        ],
        safety: "在留資格のことは法律の問題です。かならず入管でかくにんしてください。",
      },
      zh: {
        direct:
  ...
  },
  {
    ...
    content: {
      ...
      ja: {
        direct:
          "いまあぶないときは、110（警察）に電話してください。無料で、24時間、通訳もあります。急がない心配ごとは、#9110や相談窓口で話せます。",
        steps: [
          "いまあぶない：110に電話するか、近くの交番に行ってください。",
          "急がないけど心配：#9110（警察相談）に電話してください。",
          "しんじゅく多文化共生プラザでも相談できます。",
        ],
        safety: "緊急のとき：警察は 110、火事・救急車は 119です。どちらも無料です。",
      },
      zh: {
        direct:
  ...
  },
  {
    ...
    content: {
      ...
      ja: {
        direct:
          "救急のときは、いますぐ 119に電話してください。無料です。通訳もつなげます。「きゅうきゅうです」と言って、住所を言ってください。",
        steps: [
          "119に電話：「きゅうきゅうです」と言って、住所を言います。電話を切らないでください。",
          "できたらドアをあけて、在留カードと保険証を用意してください。",
          "救急車をよぶかまよったら、#7119に電話してください（24時間）。",
        ],
        safety: "病気やけがの緊急のときは、すぐ 119です。まってはいけません。",
      },
      zh: {
        direct:
  ...
  },
  {
    ...
    content: {
      ...
      ja: {
        direct:
          "はい。MINFOは「やさしい日本語」で説明できます。みじかい文とかんたんなことばをつかいます。",
        steps: [
          "上のことばのボタンで「やさしい日本語」をえらんでください。",
          "こたえがぜんぶやさしい日本語になります。",
          "むずかしい書類は、しんじゅく多文化共生プラザでもやさしく説明してくれます。",
        ],
      },
      zh: {
        direct:
  ...
  },
  {
    ...
    content: {
      ...
      ja: {
        direct:
          "外国人も、日本で銀行口座をつくることができます。でも、ルールは銀行によってちがいます。これは一般的な案内です。",
        steps: [
          "手続きは銀行ごとにちがいます。行く前に、その銀行の公式サイトでかくにんしてください。",
          "在留カード・住所がわかるもの・電話番号などを聞かれることが多いです。持っているものを持っていってください。",
          "書類がむずかしいときは、相談窓口で手つだってもらえます。",
        ],
        safety: "ルールは銀行によってちがいます。かならず銀行の公式の案内でかくにんしてください。",
      },
      zh: {
        direct:
  ...
  },
  {
    ...
    content: {
      ...
      ja: {
        direct:
          "財布をなくしたら、近くの交番か警察署にとどけてください。日本では、なくしたものがもどってくることが多いです。カードもまもりましょう。",
        steps: [
          "近くの交番か警察署で「なくしました」と言ってください。番号（受理番号）をもらえます。",
          "銀行のカードやクレジットカードが入っていたら、カード会社に電話して止めてください。",
          "在留カードが入っていたら、入管で再発行の手続きも必要です。こまったら相談窓口に聞いてください。",
        ],
        safety: "ぬすまれたときは、それも警察に言ってください。いまあぶないときは、110に電話してください。",
      },
      zh: {
        direct:
  ...
  },
  {
    ...
    content: {
      ...
      ja: {
        direct:
          "役所の手紙がわからなくても、ひとりでなやまないでください。相談窓口の人が、いっしょに読んで、なにをするかおしえてくれます。無料です。",
        steps: [
          "だれから来たか見てください。ふうとうに役所の名前があります。",
          "手紙をしんじゅく多文化共生プラザに持っていってください。いっしょに読んでくれます。",
          "お金や手続きのことは、手紙を出した役所でかくにんしてください。",
        ],
        safety: "役所の手紙には、しめきりがあることが多いです。日にちが書いてあったら、その前に行ってください。",
      },
      zh: {
        direct:
...
export const FALLBACK_CONTENT: Localized<LocalizedAnswerContent> = {
  ...
  ja: {
    direct:
      "この質問のたしかなこたえは、まだ MINFOにありません。でも、つぎの方法があります。下のカテゴリー（病院・税金・ごみ・住まい・相談）に近いものがあるかもしれません。ことばをかえて、もういちど聞いてみてください。",
    steps: [
      "しんじゅく多文化共生プラザで聞いてください。無料で、いろいろなことばで、どんな生活の質問でもだいじょうぶです。",
      "ビザ・仕事・法律のことは、FRESC（四ツ谷）で通訳つきで相談できます。",
      "かんたんなことば（「病院」「税金」「ごみ」など）で、もういちど質問してみてください。上のカテゴリーもつかえます。",
    ],
    safety: "たいせつなことやいそぐことは、かならず役所でかくにんしてください。",
  },
  zh: {
    direct:
